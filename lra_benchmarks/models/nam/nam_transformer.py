...
"""NAMTransformer model."""

from flax import nn
import jax.numpy as jnp
from lra_benchmarks.models.layers import common_layers
from lra_benchmarks.models.nam import nam_attention


class NAMTransformerBlock(nn.Module):
  ...
  def apply(self,
    ...
    x = nam_attention.NAMSelfAttention(
        x,
        num_heads=num_heads,
        dtype=dtype,
...
class NAMTransformerEncoder(nn.Module):
  """NAM Transformer Model Encoder."""
...
class NAMTransformerDualEncoder(nn.Module):
  """NAM Transformer Model for Matching (dual encoding) tasks."""
  ...
  def apply(self,
    ...
    """
    encoder = NAMTransformerEncoder.shared(
